    ...
    return (
        <div className='h-screen bg-gradient-to-br from-teal-50 via-lime-50 to-emerald-50'>
            ...
            <div className='max-w-4xl mx-auto p-6 sm:p-8'>
                <button onClick={() => navigate(-1)} className='flex items-center gap-1 px-3 py-2 text-teal-600 hover:text-emerald-700 font-medium hover:bg-teal-50 rounded-lg transition-colors duration-300'>
                    ...
                    <section className='bg-white/90 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-md border border-teal-100'>
                        ...
                        <form onSubmit={saveProfile} className='space-y-4'>
                            {personalFields.map(({ name, type, placeholder, icon: Icon }) => (
                                <div key={name} className='flex items-center border border-teal-200 rounded-xl px-4 py-3 bg-teal-50/50 focus-within:border-emerald-300 focus-within:ring-2 focus-within:ring-emerald-100 transition-all duration-200'>
                    ...
                    <section className='bg-white/90 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-md border border-teal-100'>
                        ...
                        <form onSubmit={changePassword} className='space-y-4'>
                            ...
                            <div className='mt-8 pt-6 border-t border-teal-100'>
                                ...
                                <button className='w-full py-2 px-4 bg-red-50 text-red-700 rounded-lg text-sm font-medium hover:bg-red-100 transition-colors' onClick={onLogout}>
                                    Logout
                                </button>
                            </div>
                        </form>
